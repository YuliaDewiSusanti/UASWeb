...
from susanti.models import Transaksi, DetailTransaksi
...
from susanti.forms import SusantiAddProductForm
from susanti.keranjang import Susanti
...
def beranda(request):
    ...
    susanti_product_form = SusantiAddProductForm()
    context = { "judul": "Halaman Beranda",
                "kategori" : kategori, 
                "jumlahkategori":jumlahkategori,
                "slide": slider,
                "trending":trending,
                "susanti_product_form": susanti_product_form,
    }
